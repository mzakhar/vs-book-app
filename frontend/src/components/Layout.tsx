...
import { BookOpen, LayoutDashboard, Sparkles, BookMarked, Star, Palette } from 'lucide-react';
  ...
  return (
    <div className="layout">
      ...
      <div className="glass-blobs">
        <div className="glass-blobs__item glass-blobs__item--1" />
        <div className="glass-blobs__item glass-blobs__item--2" />
        <div className="glass-blobs__item glass-blobs__item--3" />
        <div className="glass-blobs__item glass-blobs__item--4" />
      </div>
      {theme === 'rainbow' && (
